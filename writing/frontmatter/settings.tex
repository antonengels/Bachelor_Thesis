...
\usepackage{rotating}       % Querformat-Abbildungen
...
\usepackage{nameref}
% glossaries muss nach hyperref geladen werden, damit Abkürzungen klickbare Links erhalten
...
% Inhaltsverzeichnis um eine Ebene reduzieren (z. B. keine Subsections mehr)
