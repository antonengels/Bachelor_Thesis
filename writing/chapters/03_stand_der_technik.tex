...
DDQN benötigt im Vergleich zu PPO zwar weniger Hyperparameter, konvergierte in dem Projekt jedoch nicht zu einer optimalen Lösung \cite[vgl.~S.~46]{chap3_Mwa23}. 
...
RL-Agenten haben Schwierigkeiten, die Übergangsdynamik von Umgebungen so intuitiv wie Menschen zu verstehen und Vorwissen effektiv anzuwenden \cite[vgl.~S.~1]{chap1_Wexler22}. 
...
Behavioral Cloning ist eines der am besten validierten Offline-Imitation-Learning-Verfahren, das die Policy per Supervised Learning optimiert \cite[vgl.~S.~2]{chap3_Sha24}. 
...
Die Abkehr von diesen Systemen hin zum Deep Reinforcement Learning (DRL) bleibt - wie in Abschnitt \ref{sec:3.1.3} und Abschnitt \ref{sec:imitation_learning} diskutiert - durch Sample-Ineffizienz, Sparse Rewards und eingeschränkte Initialisierungsmöglichkeiten limitiert. 
...
Es mangelt an fundierten Konzepten, die die in Abschnitt \ref{sec:problemstellung} beschriebenen Initialisierungshürden zukünftiger RL-Agenten ausschließlich durch Offline Behavior Cloning auf Basis realer, historischer Betriebsdaten lösen. 
